...
import image from "../../../assets/images/deposits/kotipoti.jpg";
          ...
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify">
                It is a premium monthly deposit scheme for our valuable members
                who wants to be a Kotipoti after a certain period of time. This
                scheme will be very helpful to implement member’s future plan
                successfully by small savings.
                <h4 className="mt-5 text-xl font-semibold">Features</h4>
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Any Christian individual having savings account with Dhaka
                    credit can open this account.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    before the agreed term, the interest will be paid at
                  ...
                  >
                    ...
                    Account holder may avail loan up to 90% of the payable
                    amount. But this facility will be eligible after 1 year from
                    opening the account.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    rule/procedures, if it is deemed necessary.
                  </motion.li>
                </ul>
              </div>
