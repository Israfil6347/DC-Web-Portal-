          ...
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify">
                This account is designed to encourage savings habit among the
                Teenagers and to make them interested in becoming an active and
                integral part of Co-operative Credit Union movement.
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    50% of account balance can be withdrawn for educational
                    purposes.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    Bee Savers will be auto updated to Smart Savers from the age
                    of 13.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    Children from the age of 12 year & 1 day to 18 year can open
                    this account.
                  </motion.li>
                  ...
                  >
                    ...
                    Smart Savers are auto transferred to full membership account
                    at the age of 18.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ delay: 1.2, stiffness: 10 }}
                  >
                    <svg
                      className="mr-1.5 h-4 w-4 mt-[2px] flex-shrink-0"
                      fill="currentColor"
