          ...
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify">
                ...
                one can never fully primport {useEffect} from 'react'; epare for
                the financial requirement that may arises for any situation.
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Minimum Account Opening Deposit: Tk 500/-
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Interest Rate: 2.5%, twice a year on minimum existing
                    balance.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    Interest won’t be provided if balance is less then BDT
                    2000/-.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    Account statement will be sent to account holder’s address
                    every 3 months.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    appropriate evidence with 7 working days.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Prior notice for withdrawal is not required for amount BDT
                    5,00,000/-, but require (1 Working day) prior with written
                    notice to withdraw more than BDT 5,00,000/-.
                  </motion.li>
                </ul>
                <h4 className="mt-5 text-xl lg:text-2xl font-semibold">
                  Requirements
