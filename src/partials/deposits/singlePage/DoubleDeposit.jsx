        ...
        <div className="container mx-auto mb-20 px-4 text-left md:text-justify lg:text-justify">
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              <h2 className="font-semibold mb-2 p-1 text-2xl lg:text-3xl">
                Double Deposit Scheme
              </h2>
              <div className="mb-4 p-1 text-justify">
                This Deposit Scheme is very Lucrative that provides double
                benefits to the depositors within a certain period of time.
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Any Amount more than BDT: 10,000/- can be placed as double
                    deposit.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    After 2 years, 90% of the deposited amount can be taken as
                    Loan.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    Instant Loan with Surety for Self Loan or Family Members
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    In case of emergency, any amount can be withdrawn.
                  </motion.li>
                </ul>
              </div>
            </div>
