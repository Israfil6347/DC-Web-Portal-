          ...
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify">
                Savings is an important aspect of life for each and everyone and
                one can never fully prepare for the financial requirement that
                may arises for any situation.
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    2 Stamp size color photos, Baptism certificate & Birth
                    certificate or NID.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    Narayanganj and Munshiganj District.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Saving account is mandatory for other types of accounts
                    also.
                  </motion.li>
                </ul>
              </div>
