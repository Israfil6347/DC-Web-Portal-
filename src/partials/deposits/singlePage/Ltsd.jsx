          ...
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify">
                LTSD helps the depositor earn high rate of interest for a fixed
                term with flexible tenure.
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Duration more than BDT 10,000/- can be placed as LTSD.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    After 5 years or completing HSC, double Duration of
                    self-deposit can be received as loan @ 9% Interest per
                    annum.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    Deposit can be withdrawn at anytime, in case of emergency as
              ...
              <div className="mt-5 grid grid-cols-1 gap-4 rounded-md md:grid-cols-3 lg:grid-cols-5">
                <div className="flex flex-col gap-1 rounded-md border p-3">
                  <div className="font-semibold">Duration:6 months</div>
                  <div className="">Interest:7%</div>
                </div>
                <div className="flex flex-col gap-1 rounded-md border p-3">
                  <div className="font-semibold">Duration:12 months</div>
                  <div className="">Interest:7.50%</div>
                </div>
                <div className="flex flex-col gap-1 rounded-md border p-3">
                  <div className="font-semibold">Duration:24 months</div>
                  <div className="">Interest:8.5%</div>
                </div>
                <div className="flex flex-col gap-1 rounded-md border p-3">
                  <div className="font-semibold">Duration:36 months</div>
                  <div className="">Interest:9%</div>
                </div>
                <div className="flex flex-col gap-1 rounded-md border p-3">
                  <div className="font-semibold">Duration:60 months</div>
                  <div className="">Interest:9.5%</div>
                </div>
              </div>
            </div>
          </div>
