          ...
          <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
            ...
            <div className="">
              ...
              <div className="mb-4 p-1 text-justify">
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    We offer Fresh, Clean & Healthy Products
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Give Customers confidence & establish an environment of
                    trust
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    All the daily commodities under one roof.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                ...
                <ul className="mt-5 list-disc">
                  ...
                  <li className="mt-2 flex items-start">
                    ...
                    Special Discounts through out the year
                  </li>
                  <li className="mt-2 flex items-start">
                    <svg
                      className="mr-1.5 h-4 w-4 mt-[2px] flex-shrink-0"
                    ...
                    CC Camera Monitoring & Air-conditioned
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-20 border-t">
                <ul>
                  <h2 className="mt-5 text-2xl font-bold">Address</h2>
                  <li>
                    Head Office Outlet: 173/1/A, East Tejturi Bazar, Tejgaon,
                    Dhaka
                  </li>
                </ul>
              </div>
