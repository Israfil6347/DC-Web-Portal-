      ...
      <section className="">
        <div className="container mx-auto mb-20 px-6 text-left md:text-justify lg:text-justify">
          <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-24 lg:px-20">
            <h2 className="text-2xl lg:text-3xl font-bold">Security Service</h2>
            ...
            <div className="float-left my-3 w-full  lg:w-2/5">
              <img src={image} className="w-full pb-5 lg:pr-6" alt="" />
            </div>

            <div className="mb-7 flex flex-wrap p-1">
              <div className="p-4 md:w-1/2">
                <h4 className="text-xl lg:text-2xl font-semibold">Features</h4>
