          ...
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                ...
                living in Dhaka and with Dhaka Credit’s Flat Purchase Loan, this
                dream can become a reality with ease.
                ...
                <ul className="mt-5 list-disc text-onSurface">
                  ...
                  >
                    ...
                    Applicant’s Loan will be allowed after deducting the booking
                    money from the total price of the Flat.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Defaulters cannot apply for this Loan.
                  </motion.li>
                </ul>
                <h4 className="mt-5 text-xl lg:text-2xl font-semibold ">
                  Requirements
