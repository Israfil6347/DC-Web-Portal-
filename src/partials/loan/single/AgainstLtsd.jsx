          ...
          <div className="text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                A member can take this Loan even though the member have a
                General Loan and any Savings Account Holder can use their own
                Long Term Savings Deposit amount as surety but don’t take Loan
                if given Surety.
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Account Holder can take 95% Loan against the deposit amount.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Based on Member’s LTSD, any amount upto 95% can be approved
                    as Loan.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    Interest Rate is counted on the Basis of Continuous Reducing
                    Manner.
                  </motion.li>
                </ul>
              </div>
