          ...
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                This Loan scheme is a good option for members who are looking to
                travel abroad by providing them with financial assistance.
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Interest Rate: 13.5%, but interest of total Loan to be
                    deposited at a time in Savings Accounts before receiving the
                    Loan.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Having completed member’s bank solvency requirements, the
                    member has to issue a cheque of the similar Loan amount to
                    the union.
                  </motion.li>
                </ul>
              </div>
