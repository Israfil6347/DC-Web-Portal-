          ...
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                ...
                Credit’s Gym Loan can be an important part to lead a healthy
                lifestyle.
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    The Union provides Loan to members for one year at a time.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Loan amount will be directly paid as advance gym fee.
                  </motion.li>
                </ul>
                <h4 className="mt-5 text-xl lg:text-2xl font-semibold ">
                  Requirements
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Must be a full member in the Union.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Must be a regular in depositing savings in the Union.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Must be a regular member of Health Care Scheme.
                  </motion.li>
                </ul>
              </div>
              <div className="container mx-auto px-2">
                <div className="flex flex-wrap">
                  <div className="pt-6 md:w-full lg:w-1/2 xl:w-1/3">
                    ...
                    <ul className="text-onSurface">
                      <li className="flex items-center">
                        ...
                        For General Member's 1200 taka .
                      </li>
                      <li className="flex items-center">
                        <svg
                          className="mr-1.5 h-4 w-4 mt-[2px] flex-shrink-0"
                  ...
                  <div className=" pt-6 md:w-full lg:w-1/2 xl:w-1/3">
                    ...
                    <ul className="text-onSurface">
                      <li className="flex items-center">
                        ...
                        For General Member's 3,000 taka BDT
                      </li>
                      <li className="flex items-center">
                        <svg
                          className="mr-1.5 h-4 w-4 mt-[2px] flex-shrink-0"
                        ...
                        For Student's BDT 2,285 Taka
                      </li>
                    </ul>
                  </div>

                  <div className="  md:w-full lg:w-1/2 xl:w-1/3 pt-6">
                    <h2 className="title-font mb-2 text-lg font-medium text-onSurface sm:text-xl">
                      Half-Yearly
                    </h2>
                    ...
                    <ul className="text-onSurface">
                      <li className="flex items-center">
                        ...
                        For General Member's 6,000 taka BDT
                      </li>
                      <li className="flex items-center">
                        <svg
                          className="mr-1.5 h-4 w-4 mt-[2px] flex-shrink-0"
                  ...
                  <div className="  md:w-full lg:w-1/2 xl:w-1/3 pt-6">
                    ...
                    <ul className="text-onSurface">
                      <li className="flex items-center ">
                        ...
                        For General Member's 12,000 taka BDT
                      </li>
                      <li className="flex items-center">
                        <svg
                          className="mr-1.5 h-4 w-4 mt-[2px] flex-shrink-0"
