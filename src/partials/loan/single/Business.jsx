          ...
          <div className="text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                ...
                their business and to increase their productivity & profit.
                ...
                <ul className="mt-5 list-disc ">
                  ...
                  >
                    ...
                    Mortgage Land, Flat, Factory should be in applicant’s name.
                  </motion.li>
                </ul>
                <h4 className="mt-5 text-xl lg:text-2xl font-semibold ">
                  Requirements
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    TIN certificate with the last 3 years income tax slip.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
