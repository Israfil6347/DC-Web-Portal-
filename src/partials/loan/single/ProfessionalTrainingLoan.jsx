          ...
          <div className="animate-slideInUp text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                ...
                Loan is to support those training cost and help the member get
                through the course without worrying about the High Training
                Cost.
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Highest Loan: BDT 100,000 or 20 times the current share.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                  ...
                  >
                    ...
                    Loan Tenure: After 6 months of completing course, highest 3
                    years/ 36 equal installments.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                    initial={{ opacity: 0, x: window.innerWidth }}
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Minimum Qualification is Graduate for sales and photography
                    training.
                  </motion.li>
                  <motion.li
                    className="mt-2 flex"
                  ...
                  >
                    ...
                    Minimum 8th Grade Pass for Junior Nursing, Driving and
                    Catering Training.
                  </motion.li>
                </ul>
              </div>
